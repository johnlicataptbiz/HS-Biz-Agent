  ...
  return (
    <div className="glass-card p-6 h-full border-rose-500/20 bg-rose-500/5 flex flex-col justify-between group transition-all duration-500 hover:bg-rose-500/10">
      <div className="space-y-4">
        <div className="flex justify-between items-start">
          ...
          <div className="text-right">
            ...
            <h3 className="text-2xl font-black text-slate-900 decoration-rose-500/30 underline decoration-2 underline-offset-4">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between text-xs font-bold uppercase tracking-widest text-slate-600">
            ...
            <span className="text-slate-900">{report.stalledDeals}</span>
          </div>
          <div className="flex items-center justify-between text-xs font-bold uppercase tracking-widest text-slate-600">
            <span className="flex items-center gap-2">
              <Users size={14} className="text-rose-500" /> Inactive Leads
            </span>
            <span className="text-slate-900">{report.coldLeads}</span>
          </div>
        </div>
      </div>
      ...
      <button
        ...
        className="mt-6 w-full py-3 rounded-xl bg-rose-500 text-slate-900 text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-rose-600 transition-all shadow-lg shadow-rose-500/20"
      >
