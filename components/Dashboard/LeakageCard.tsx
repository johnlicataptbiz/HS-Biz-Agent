...
import { performanceService, LeakageReport } from '../../services/performanceService';
import { AlertCircle, TrendingDown, Clock, ArrowRight, DollarSign, Users } from 'lucide-react';
...
const LeakageCard: React.FC = () => {
    ...
    if (!report || (report.stalledDeals === 0 && report.coldLeads === 0)) return null;
            ...
            <div className="space-y-4">
                <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                        <p className="text-[10px] font-black text-rose-400 uppercase tracking-widest">Revenue Leakage</p>
                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between text-xs font-bold uppercase tracking-widest text-slate-400">
                        <span className="flex items-center gap-2"><Clock size={14} className="text-rose-500" /> Stalled Deals</span>
                        <span className="text-white">{report.stalledDeals}</span>
                    </div>
                    <div className="flex items-center justify-between text-xs font-bold uppercase tracking-widest text-slate-400">
                        <span className="flex items-center gap-2"><Users size={14} className="text-rose-500" /> Inactive Leads</span>
