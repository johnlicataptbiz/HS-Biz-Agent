  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="flex gap-4">
          <div className="relative group">
            ...
            <input
              ...
              className="w-80 bg-slate-100 border border-slate-200 rounded-2xl py-4 pl-12 pr-6 text-slate-900 font-bold uppercase tracking-widest text-xs focus:outline-none focus:border-indigo-500/50 transition-all shadow-2xl"
            />
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <button className="flex items-center justify-center gap-3 p-4 glass-card bg-slate-100 hover:bg-slate-200 border-slate-200 text-slate-600 font-black uppercase tracking-widest text-[10px] transition-all">
      ...
      <div className="glass-card overflow-hidden border-slate-200">
                ...
                >
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500/20 to-purple-500/20 border border-slate-200 flex items-center justify-center text-indigo-400 font-black text-xs italic">
                  ...
                  <td className="px-6 py-5">
                    <span className="px-3 py-1 rounded-full bg-slate-100 border border-slate-200 text-[9px] font-black text-slate-600 uppercase tracking-widest italic">
        ...
        <div className="p-6 border-t border-slate-200 flex justify-between items-center bg-white/[0.01]">
          <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">
            Displaying {filtered.length} of {contacts.length} Records
          </p>
          <div className="flex gap-2">
            <button className="px-4 py-2 rounded-xl bg-slate-100 border border-slate-200 text-[10px] font-black text-slate-600 uppercase tracking-widest hover:text-slate-900 transition-all">
              Previous
            </button>
